...
void CCheckBox::Draw(bool hover)
{
	...
	if (Checked)
	{
		Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(32, 80, 31, 255));
...
void CSlider::Draw(bool hover)
{
	...
	Render::Clear(a.x, a.y + 3, m_iWidth, 1, Color(128, 128, 128, 255));
	Render::Clear(a.x, a.y + 7, m_iWidth, 1, Color(128, 128, 128, 255));
	Render::Clear(a.x + m_iWidth, a.y + 3, 1, m_iHeight - 6, Color(128, 128, 128, 255));
	Render::Clear(a.x, a.y + 3, 1, m_iHeight - 6, Color(128, 128, 128, 255));
	float Ratio = Value / (Max - Min);
	float Location = Ratio*m_iWidth;

	Render::GradientV(a.x + Location, a.y + 1, 4, 9, Color(32, 45, 31, 255), Color(32, 80, 31, 255));
	...
	Render::Text(a.x + (m_iWidth / 2) - txtSize.right / 2, a.y + 10, Color(220, 221, 220, 255), Render::Fonts::MenuBold, buffer);
}
...
void CKeyBind::Draw(bool hover)
{
	...
	Render::Text(a.x + 2, a.y + 2, Color(220, 221, 220, 255), Render::Fonts::MenuBold, KeyName);
}
...
void CComboBox::Draw(bool hover)
{
	...
	{
		// The current item
		Render::Text(a.x + 2, a.y + 2, Color(220, 221, 220, 255), Render::Fonts::MenuBold, GetItem().c_str());

		// If the drop down part is open
		if (IsOpen)
		{
			Render::Clear(a.x, a.y + 17, m_iWidth, Items.size() * 16, Color(58, 56, 58, 255));
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				Render::Text(a.x + 2, a.y + 19 + i * 16, Color(220, 221, 220, 255), Render::Fonts::MenuBold, Items[i].c_str());
			}
		}
	}
}
