...
public:
	...
	char name[512]; //0x0010 
	char pad_0x0050[0x40]; //0x0050
	__int32 userID; //0x0090 
	char guid[32]; //0x0094 
	char pad_0x00B4[0x180]; //0x00B4
	bool SetupSkeleton(matrix3x4 *pBoneToWorldOut, int nMaxBones, int boneMask, float currentTime)
	{
	...
	Vector GetSkeletonPos(int i)
	{
		matrix3x4 boneMatrix[128];
		if (this->SetupSkeleton(boneMatrix, 128, BONE_USED_BY_HITBOX, GetTickCount64()))
		{
