...
void Render::Initialise()
{
	...
	Fonts::HealthESP = Interfaces::Surface->FontCreate();
	// Font Settings
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Tabs, "psilent-finalfont", 42, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBY, "Segoe UI", 70, 900, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::HealthESP, "Verdana", 12, 50, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
